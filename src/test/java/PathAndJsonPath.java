...
public class PathAndJsonPath {
    ...
    public void extractingPath() {
        ...
        System.out.println("pastCode = " + postCode);
    }
    ...
    public void getZipCode() {
        ...
        given()
                ...
                .extract().response()
                ;
        Location locPathAs = response.as(Location.class); // bütün classları yazmak zorundasn
        System.out.println("locPathAs = " + locPathAs.getPlaces());

        List<Place> places = response.jsonPath().getList("places", Place.class); // nokta atışı istediğimiz nesneyi aldik
